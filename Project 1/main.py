...
Axis3clockwise = Button(control_frame, text="CW - W",width=17, command=lambda: PaintBot.Axis3Clockwise(LabelAngle3))
Axis3Counterclockwise = Button(control_frame, text="CCW - Q", width=17,command=lambda: PaintBot.Axis3Counter_clockwise(LabelAngle3))
...
ResetRobotButton = Button(control_frame, text="Reset Robot - R",width=17, command = PaintBot.resetRobot)
ResetRobotButton.pack(side=TOP, pady=10)

# Create a erase button for the paint frame 
EraseButton = Button(control_frame, text="Erase All - F",width=17, command = EraseAll())  ############################## Incomplete ######################
...
# Hotkey for Axis3 
#root.bind("<q>",PaintBot.Axis3Counter_clockwise)
#root.bind("<w>",PaintBot.Axis3Clockwise)

# Hotkey for Axis2
#root.bind("<a>",PaintBot.Axis2Counter_clockwise)
#root.bind("<s>",PaintBot.Axis2Clockwise)

# Hotkey for Axis1
#root.bind("<z>",PaintBot.Axis1Counter_clockwise)
#root.bind("<x>",PaintBot.Axis1Clockwise)
